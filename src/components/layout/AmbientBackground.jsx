  ...
  const orbs = [
    {
      ...
      style: { background: "radial-gradient(circle, hsl(var(--primary) / 0.20), transparent 70%)" },
      animate: { x: [0, 36, 0], y: [0, 24, 0], opacity: [0.45, 0.62, 0.45] },
    ...
    },
    {
      ...
      animate: { x: [0, -30, 0], y: [0, 34, 0], opacity: [0.35, 0.52, 0.35] },
      transition: { duration: 24, repeat: Infinity, ease: "easeInOut" },
    },
    {
      className: "absolute -bottom-32 left-1/4 w-[400px] h-[400px] ambient-orb",
      style: { background: "radial-gradient(circle, hsl(var(--information) / 0.12), transparent 70%)" },
      animate: { x: [0, 44, 0], y: [0, -22, 0], opacity: [0.3, 0.46, 0.3] },
