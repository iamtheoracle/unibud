...
const DEFAULT = { primary_color: "#7FD8FF", accent_color: "#7FD8FF", background: "#0B0B0C", font_heading: "SF Pro Display", font_body: "SF Pro Text", icon_set: "lucide", logo_url: "", institution_theme: "", branding_notes: "" };
