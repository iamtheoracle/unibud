    ...
    <motion.button
      ...
      className={`flex items-center gap-2 font-semibold transition-all duration-200 ${
        isCard
          ...
          : `px-4 py-2.5 rounded-full text-[13px] ${selected ? "bg-primary text-primary-foreground shadow-[0_2px_12px_rgba(109, 40, 217,0.3)]" : "bg-card text-foreground border border-border/50"}`
      }`}
    >
