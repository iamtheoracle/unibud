 ...
 */
export default function CommunityShell({ title, icon: Icon, liveLabel, liveTo, children, actions, accent = "0 0% 100%" }) {
  return (
      ...
      <header className="sticky top-0 z-30 bg-background/85 backdrop-blur-xl border-b border-border/15">
        <div className="max-w-2xl mx-auto px-4 h-14 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-7 h-7 rounded-lg flex items-center justify-center" style={{ background: `hsl(${accent})`, color: "hsl(0 0% 100%)" }}>
          ...
          <div className="flex items-center gap-2">
            {actions}
            {liveLabel && (
              <button className="flex items-center gap-1 px-3 py-1.5 rounded-full text-[11px] font-semibold spring-tap" style={{ background: `hsl(${accent})`, color: "hsl(0 0% 100%)" }}>
