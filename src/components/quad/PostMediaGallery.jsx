...
import OrbitMediaViewer from "@/components/media/OrbitMediaViewer";

/**
 * Media gallery for posts — supports images, videos, and documents.
 * Opens the premium OrbitMediaViewer on tap.
 */
export default function PostMediaGallery({ mediaUrls = [], mediaTypes = [], post, user }) {
