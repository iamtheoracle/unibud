  ...
  return (
    ...
    >
      {Icon && (
        ...
        >
          <div className="w-18 h-18 rounded-[22px] crystal-card flex items-center justify-center mb-6 edge-light" style={{ width: 72, height: 72 }}>
      ...
      {budGuidance && (
        <div className="mt-5 px-4 py-2.5 rounded-2xl glass max-w-[300px]">
