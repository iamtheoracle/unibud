...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-card/85 backdrop-blur-2xl border border-border/30 p-6 premium-shadow transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
