...
/**
 * QuickActionCapsule — the floating top contextual action strip.
 *
 * Fixed at the top of the viewport. Adapts to the current operating mode.
 * Bud is intentionally NOT here — it lives as the floating AI companion.
 */
      ...
      <div className="fixed top-0 left-0 right-0 z-[9997] safe-area-pt pointer-events-none app-content">
        ...
        >
          <motion.div
            layout
            transition={SPRING}
            className="glass rounded-full h-10 px-1.5 flex items-center gap-1 soft-shadow"
          >
