...
// UNIBUD wordmark replaces the old logo mark on the loading screen
    ...
    return (
      <div className="fixed inset-0 flex items-center justify-center bg-background">
        <div className="flex flex-col items-center gap-3">
          <h1 className="font-heading font-extrabold tracking-[0.16em] text-[22px] text-foreground">UNIBUD</h1>
