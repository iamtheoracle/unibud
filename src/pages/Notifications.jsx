    ...
    <div className="min-h-screen">
      <div className="pt-12 pb-3 px-5 flex items-center gap-3">
        ...
        <div className="flex-1">
          <h1 className="font-heading font-bold text-[18px]">Notifications</h1>
        </div>
        <button className="text-[12px] font-medium text-primary">Mark all read</button>
      </div>
      ...
      <div className="px-4 space-y-2 pb-8">
        {notifications.map((n, i) => {
          ...
          const Icon = cfg.icon;
          return (
            <GlassCard key={i} variant="solid" className={`p-3 ${!n.read ? "border-l-2 border-l-primary" : ""}`} delay={i * 0.04}>
