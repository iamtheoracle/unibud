...
export default function ManagementCenter() {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-br from-info/8 via-transparent to-transparent pointer-events-none" />
        <div className="relative flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-[20px] bg-info/15 flex items-center justify-center">
          ...
          <div className="flex items-center gap-6">
            <div className="text-center">
              <p className="text-[20px] font-heading font-extrabold text-warning">{pendingOutreach.length}</p>
              <p className="text-[10px] text-muted-foreground">Pending</p>
            </div>
            <div className="text-center">
              <p className="text-[20px] font-heading font-extrabold text-success">{acceptedOutreach.length}</p>
        ...
        <div className="p-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {MANAGEMENT_SECTIONS.map((section, i) => (
            <motion.button
              ...
              className="text-left p-4 rounded-[22px] border border-border/20 bg-muted/20 hover:bg-muted/40 spring-tap"
            >
