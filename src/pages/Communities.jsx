...
const DEMO_COMMUNITIES = [
  { id: "dc1", name: "University of Benin", type: "university", description: "The official UNIBUD community for all students.", members_count: 12450, is_verified: true, is_official: true, accent_color: "46 65% 52%" },
  ...
  { id: "dc3", name: "Department of Computer Science", type: "department", description: "CSC students, lecturers, and resources.", members_count: 850, is_verified: true, is_official: true, accent_color: "142 72% 29%" },
  { id: "dc4", name: "200 Level Computer Science", type: "level", description: "200L CSC students — your class community.", members_count: 210, is_verified: true, is_official: true, accent_color: "0 73% 51%" },
  { id: "dc5", name: "CSC 301 — Data Structures", type: "course", course_code: "CSC 301", description: "Course space for lectures, notes, and discussions.", members_count: 180, is_verified: true, is_official: true, accent_color: "217 89% 53%" },
  ...
  { id: "dc7", name: "AI Research Group", type: "research_group", description: "Exploring machine learning and AI applications.", members_count: 45, accent_color: "142 72% 29%" },
  { id: "dc8", name: "Student Union Government", type: "sug", description: "The official student government body.", members_count: 120, is_verified: true, is_official: true, accent_color: "46 65% 52%" },
  ...
  { id: "dc10", name: "Photography Enthusiasts", type: "interest_group", description: "Capturing moments on and off campus.", members_count: 95, accent_color: "142 72% 29%" },
];
        ...
        {isLoading ? (
          Array.from({ length: 5 }).map((_, i) => (
            <div key={i} className="bg-card rounded-[20px] p-4 soft-shadow border border-border/40 flex items-center gap-3">
              <div className="w-12 h-12 rounded-[16px] bg-muted animate-pulse" />
