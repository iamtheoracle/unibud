...
const ENTITY_API_GROUPS = [
  ...
  { domain: "Identity & Records", entities: ["AcademicTimelineEntry", "StudentRecord", "StudentDocument", "StudentIdentifier", "InstitutionDocument", "PortfolioItem", "DigitalBadge", "VerificationRequest", "Admission", "WellnessEntry"], status: API_STATUS.PRODUCTION },
...
const SECURITY = {
  ...
  privacy: { status: API_STATUS.PRODUCTION, notes: "matriculationPrivacy + {{user.id}} consent scoping" },
