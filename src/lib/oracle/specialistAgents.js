...
export const SPECIALIST_AGENTS = [
  ...
  },
  {
    ...
    tagline: "Designs, validates, and evolves every product surface",
    description:
      "Orbit owns the complete lifecycle of product organization — discovery, architecture, UX, UI, engineering design, information architecture, platform evolution, design systems, and product validation.",
    owns: [
      "Product discovery",
